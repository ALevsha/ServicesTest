...
class MyService: Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
         ...
         *
         *  С версии android Oreo (API 26) для перезапуска сервиса, при его работе должно
         *  выводиться уведомление для пользователя. Из соображений безопасности, чтобы не было
         *  незадекларированных операций в фоне.
         * */
